...
// CustomChannels allows you to add custom channel ids
func CustomChannels(channels ...byte) Option {
	return func(n *Node) {
		nodeInfo := n.nodeInfo.(p2p.DefaultNodeInfo)
		nodeInfo.Channels = append(nodeInfo.Channels, channels...)
		n.nodeInfo = nodeInfo
	}
}
...
func NewNode(config *cfg.Config,
	...
	nodeInfo, err := makeNodeInfo(config, nodeKey, txIndexer, genDoc, state, extChannels)
	if err != nil {
		return nil, err
	}
...
func makeNodeInfo(
	...
	nodeInfo.Channels = append(nodeInfo.Channels, extChannels...)
